...
import 'package:leave_manager/custom_widgets/counter_text.dart';
...
class _MainProfilePageState extends State<MainProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.days == null){
      AppConstants.usedDays = 0;
    } else {
      AppConstants.usedDays += int.parse(widget.days!);
    }
    int total = 30;
    int used = AppConstants.usedDays;
